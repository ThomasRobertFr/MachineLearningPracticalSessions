...
%%
%
% On voit que la /bandwidth/ règle bien la dispersion des données donnant
% des classes plus petites (et plus vraiment représentatives de la
% ditsribution des données).
